...
const AddKandangForm = ({ visible, onCancel, onOk, confirmLoading }) => {
      ...
      try {
        ...
        if (statusCode === 200) {
          const peternak = content.map((item) => ({
            ...
            lokasi: item.lokasi, // Assuming location is in "desa, kecamatan, kabupaten, provinsi"
  ...
  const handlePeternakChange = useCallback(
    async (value) => {
      const selectedPeternak = peternakList.find(
        (peternak) => peternak.idPeternak === value
      )

      if (selectedPeternak) {
        const [desa, kecamatan, kabupaten, provinsi] = selectedPeternak.lokasi
          .split(', ')
          .map((item) => item.trim())

        setMergedLocation(selectedPeternak.lokasi)
        ...
        form.setFieldsValue({
          ...
          kecamatan,
          desa,
          alamat: selectedPeternak.lokasi,
        })
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item
              label="Nama Kadang:"
              name="namaKandang"
              rules={[{ required: true, message: 'Silahkan isi Nama Kandang' }]}
            >
          ...
          <Col span={12}>
            <Form.Item
              ...
              name="nilaiBangunan"
              rules={[
                { required: true, message: 'Silahkan isi Nilai Bangunan' },
              ]}
            >
          ...
          <Col span={12}>
            <Form.Item
              label="Luas Kandang:"
              name="luas"
              rules={[{ required: true, message: 'Silahkan isi luas' }]}
            >
          ...
          <Col span={12}>
            <Form.Item
              ...
              name="kapasitas"
              rules={[{ required: true, message: 'Silahkan isi kapasitas' }]}
            >
          ...
          <Col span={12}>
            <Form.Item
              label="Jenis Kandang"
              name="jenisKandang"
              rules={[{ required: true, message: 'Pilih Jenis Kandang!' }]}
            >
          ...
          <Col span={12}>
            <Form.Item label="Jenis Hewan:" name="jenis_id">
