...
const EditKelahiranForm = ({ visible, onCancel, onOk, confirmLoading, currentRowData }) => {
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical">
        <Form.Item name="idKejadian" label="ID Kejadian:" initialValue={currentRowData.idKejadian}>
          <Input disabled />
        </Form.Item>
        ...
        <Form.Item name="peternak_id" label="Nama Peternak:" rules={[{ required: true }]}>
        ...
        <Form.Item name="hewan_id" label="Eartag Induk:" rules={[{ required: true }]}>
        ...
        <Form.Item name="inseminasi_id" label="ID Inseminasi:" rules={[{ required: true }]}>
        ...
        <Form.Item name="kandang_id" label="Kandang Anak:" rules={[{ required: true }]}>
        ...
        <Form.Item name="petugas_id" label="Petugas Pelapor:" rules={[{ required: true }]}>
