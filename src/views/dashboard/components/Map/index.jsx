...
class Map extends Component {
  ...
  render() {
    const position = [-8.13322, 113.222603];
    ...
    return (
      <MapContainer center={position} zoom={11.5} style={{ width: "100%", height: "100%" }}>
        ...
        {kandang.map((kdg, index) => {
          ...
          const jumlahHewan = hewans.filter((hwn) => hwn.kandang.idKandang === idKandang).length;
