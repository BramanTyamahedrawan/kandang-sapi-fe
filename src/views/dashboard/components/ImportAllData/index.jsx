  ...
  saveImportedData = async (columnMapping) => {
    ...
    try {
      ...
      for (const row of importedData) {
        ...
        const nikPeternak = cleanNik(row[columnMapping["NIK Pemilik Ternak*)"]]);
        ...
        const dataPeternak = {
          ...
          tanggalLahir: formatDateToString(row[columnMapping["Tanggal Lahir Pemilik Ternak"]] || "-"),
        ...
        if (!uniqueData.has(row[columnMapping["Jenis Vaksin**)"]])) {
          dataJenisVaksin = {
            ...
            namaVaksin: row[columnMapping["Jenis Vaksin**)"]] || "Jenis Vaksin Tidak Valid",
        ...
        if (!uniqueData.has(row[columnMapping["Nama Vaksin**)"]])) {
          const dataNamaVaksin = {
            ...
            idJenisVaksin: dataJenisVaksin ? dataJenisVaksin.idJenisVaksin : generateIdJenisVaksin,
            namaVaksin: row[columnMapping["Nama Vaksin**)"]] || "Nama Vaksin Tidak Valid",
        ...
        const dataVaksin = {
          ...
          jenisVaksin: row[columnMapping["Jenis Vaksin**)"]] || "Jenis Vaksin Tidak Valid",
          namaVaksin: row[columnMapping["Nama Vaksin**)"]] || "Nama Vaksin Tidak Valid",
          kodeEartagNasional: getValidData(row, columnMapping, "No. Eartag***)"),
