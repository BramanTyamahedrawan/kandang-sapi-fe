...
const EditRumpunHewanForm = forwardRef((props, ref) => {
  ...
  return (
    <Modal
      ...
      destroyOnClose
    >
      <Form form={form} layout="vertical" name="EditRumpunHewanForm" onFinish={onFinish}>
        <Form.Item name="rumpun" label="Rumpun Hewan:" rules={[{ required: true, message: "Silahkan masukkan rumpun hewan!" }]}>
        ...
        <Form.Item name="deskripsi" label="Deskripsi:" rules={[{ required: true, message: "Silahkan masukkan deskripsi!" }]}>
          <Input.TextArea placeholder="Masukkan deskripsi rumpun hewan" autoSize={{ minRows: 3, maxRows: 6 }} />
        </Form.Item>
      </Form>
    </Modal>
  );
