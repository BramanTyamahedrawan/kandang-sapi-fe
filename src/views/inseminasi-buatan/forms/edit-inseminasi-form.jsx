...
const EditInseminasiBuatanForm = ({ visible, onCancel, onOk, confirmLoading, currentRowData }) => {
  const [form] = Form.useForm();
  const [petugasList, setPetugasList] = useState([]);
  const [peternakList, setPeternakList] = useState([]);
  const [hewanList, setHewanList] = useState([]);

  const { idInseminasi, tanggalIB, peternak, hewan, ib, idPejantan, idPembuatan, bangsaPejantan, produsen, petugas } = currentRowData || {};
  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" initialValues={{}}>
        <Form.Item label="ID Inseminasi:" name="idInseminasi" initialValue={idInseminasi}>
          <Input disabled />
        </Form.Item>
        <Form.Item label="Tanggal IB:" name="tanggalIB" initialValue={tanggalIB}>
          <Input type="date" placeholder="Masukkan Tanggal IB" />
        </Form.Item>
        <Form.Item label="Inseminator:" name="petugas_id" initialValue={petugas?.nikPetugas}>
        ...
        <Form.Item label="Produsen:" name="produsen" initialValue={produsen || "BBIB Singosari"}>
          <Select>
            <Option value="BBIB Singosari">BBIB Singosari</Option>
            <Option value="BIB Lembang">BIB Lembang</Option>
          </Select>
        </Form.Item>
        <Form.Item label="Nama Peternak:" name="peternak_id" initialValue={peternak?.idPeternak}>
        ...
        <Form.Item label="Eartag Hewan:" name="hewan_id" initialValue={hewan?.kodeEartagNasional}>
        ...
        <Form.Item label="ID Pejantan:" name="idPejantan" initialValue={idPejantan}>
          <Input placeholder="Masukkan ID Pejantan" />
        </Form.Item>
        <Form.Item label="Bangsa Pejantan:" name="bangsaPejantan" initialValue={bangsaPejantan || "Sapi Limosin"}>
          <Select>
        ...
        <Form.Item label="ID Pembuatan:" name="idPembuatan" initialValue={idPembuatan}>
