        ...
        <Row gutter={16}>
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Pilih petugas pemeriksa kebuntingan!",
                },
              ]}
            >
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item
              name="idKandang"
              label="Kandang"
              rules={[{ required: true, message: "Pilih kandang!" }]}
            >
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item
              ...
              rules={[
                { required: true, message: "Silahkan Pilih No Kartu Ternak" },
              ]}
            >
          ...
          <Col xs={24} sm={24} md={12}>
            <Form.Item
              name="idRumpunHewan"
              label="Spesies"
              rules={[{ required: true, message: "Pilih spesies!" }]}
            >
