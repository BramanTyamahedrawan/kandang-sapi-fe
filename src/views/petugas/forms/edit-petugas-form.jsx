  ...
  ({ visible, onCancel, onOk, confirmLoading, currentRowData }, ref) => {
    ...
    const loadRegenciesAndDistricts = (provincesData, rowData) => {
      const selectedProvince = provincesData.find(
        (province) => province.name === rowData.provinsi
      );
        ...
        fetch(
          ...
          .then((regencyData) => {
            ...
            const selectedRegency = regencyData.find(
              (regency) => regency.name === rowData.kabupaten
            );
            if (selectedRegency) {
              fetch(
                ...
                .then((districtData) => {
                  ...
                  const selectedDistrict = districtData.find(
                    (district) => district.name === rowData.kecamatan
                  );
                  if (selectedDistrict) {
      ...
      <Modal
        ...
        <Form
          ...
          <Form.Item
            ...
            name='noTelp'
            rules={[
              { required: true, message: "Masukkan No Telepon Petugas!" },
            ]}>
          ...
          <Form.Item label='Provinsi' name='provinsi'>
            <Select
              ...
              value={form.getFieldValue("provinsi")}>
          ...
          <Form.Item label='Kabupaten' name='kabupaten'>
            <Select
              ...
              value={form.getFieldValue("kabupaten")}>
          ...
          <Form.Item label='Kecamatan' name='kecamatan'>
            <Select
              ...
              value={form.getFieldValue("kecamatan")}>
          ...
          <Form.Item
            ...
            name='wilayah'
            rules={[
              { required: true, message: "Wilayah akan otomatis terisi" },
            ]}>
