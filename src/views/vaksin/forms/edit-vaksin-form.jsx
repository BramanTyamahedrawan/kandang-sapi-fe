  ...
  useEffect(() => {
    ...
    if (currentRowData) {
      ...
      form.setFieldsValue({
        ...
        idNamaVaksin: currentRowData.namaVaksin?.idNamaVaksin,
        ...
        petugas_id: currentRowData.petugas?.petugasId,
        batchVaksin: currentRowData.batchVaksin,
        vaksinKe: currentRowData.vaksinKe,
      });
    }
  }, [currentRowData, form]);
